...
<p align="center">
  I'm a Software Engineering student at UIT – VNUHCM, passionate about building web and mobile applications. I enjoy turning ideas into clean, functional software and am constantly learning new technologies to grow as a developer.
</p>
...
<p align="center">
  ...
  <a href="https://www.facebook.com/naclh2o">
...
<img align="right" src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" alt="coding gif" width="260" />

- 🎓 Studying **Software Engineering** at SNU **
- 💻 Coding almost every day — building projects to sharpen my skills
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Scalable web & mobile apps with clean UI and solid architecture</li>
        <li>Deep understanding of software design patterns and best practices</li>
        <li>Contributing to open-source and team-based projects</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <strong>🔭 Current Focus</strong>
      <ul>
        <li>Full-stack development: React, Node.js, .NET, Vue.js</li>
        <li>Building personal projects from idea to deployment</li>
        <li>Exploring AI-powered features in modern applications</li>
      </ul>
    </td>
  </tr>
</table>
